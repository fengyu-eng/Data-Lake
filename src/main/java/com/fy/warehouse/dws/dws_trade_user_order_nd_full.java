...
// 交易域用户粒度订单最近30日汇总表
public class dws_trade_user_order_nd_full {
    public static void main(String[] args) {
        ...
        // 创建catalog（URL统一为Java代码标准的192.168.10.102:9083）
        ...
        // 创建paimon表
        String paimonSql = "CREATE TABLE IF NOT EXISTS dws.dws_trade_user_order_nd_full(\n" +
        ...
        // 数据插入
        String insertSql = "insert into dws.dws_trade_user_order_nd_full select\n" +
                "    `user_id`                    ,--BIGINT COMMENT '用户id',\n" +
                "    `k1`                         ,--STRING COMMENT '分区字段',\n" +
                "    count(order_id) `order_count_30d`            ,--BIGINT COMMENT '最近30日下单次数',\n" +
                "    sum(sku_num) `order_num_30d`              ,--BIGINT COMMENT '最近30日下单商品件数',\n" +
        ...
        System.out.println("dws_trade_user_order_nd_full导入任务启动成功");
    }
}