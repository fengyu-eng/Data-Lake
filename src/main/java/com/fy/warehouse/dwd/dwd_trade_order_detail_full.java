...
//交易域下单事务事实表
public class dwd_trade_order_detail_full {
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        //创建paimon表
        String paimonSQL = "CREATE TABLE IF NOT EXISTS dwd.dwd_trade_order_detail_full(\n" +
        ...
        //导入数据
        String insertSql = "INSERT INTO dwd.dwd_trade_order_detail_full(id, k1, order_id, user_id, sku_id, province_id, activity_id, activity_rule_id, coupon_id, date_id, create_time, source_id, source_type_code, source_type_name, sku_num, split_original_amount, split_activity_amount, split_coupon_amount, split_total_amount)\n" +
                "select\n" +
                "    od.id,\n" +
                "    k1,\n" +
                "    order_id,\n" +
        ...
        System.out.println("dwd_trade_order_detail_full表任务启动成功");
        tableResult.await();
    }
}