...
//工具域优惠券领取事务事实表
public class dwd_tool_coupon_get_full {
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        //创建paimon表
        String paimonSQL = "CREATE TABLE IF NOT EXISTS dwd.dwd_tool_coupon_get_full(\n" +
        ...
        //导入数据
        String insertSql = "insert into dwd.dwd_tool_coupon_get_full(\n" +
                "    id,\n" +
                "    k1,\n" +
                "    coupon_id,\n" +
                "    user_id,\n" +
        ...
        System.out.println("dwd_tool_coupon_get_full表任务启动成功");
        tableResult.await();
    }
}