...
public class dwd_trade_cart_full {
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        //创建paimon表
        String paimonSQL = "CREATE TABLE IF NOT EXISTS dwd.dwd_trade_cart_full(\n" +
        ...
        //导入数据
        String insertSql = "INSERT INTO dwd.dwd_trade_cart_full(\n" +
                "    id,\n" +
                "    k1,\n" +
                "    user_id,\n" +
                "    sku_id,\n" +
        ...
        System.out.println("dwd_trade_cart_full表任务启动成功");
        tableResult.await();
    }
}