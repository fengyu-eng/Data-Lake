...
// 类名对应收藏表：ods_favor_info_full
public class ods_favor_info_full {
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        String cdcSql = "CREATE TABLE favor_info_full_mq (\n" +
        ...
        String paimonDDl = "CREATE TABLE IF NOT EXISTS ods.ods_favor_info_full(\n" +
                "    `id` bigint NOT NULL COMMENT '编号',\n" + // 修正原SQL注释（原为"购物券编号"）
        ...
        String insertSql = "INSERT INTO ods.ods_favor_info_full(\n" +
                "    `id`,\n" +
                "    `k1`,\n" +
                "    `user_id`,\n" +
                "    `sku_id`,\n" +
        ...
        System.out.println("favor_info导入任务启动成功");
        tableResult.await();
    }
}