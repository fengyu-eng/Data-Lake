...
// 类名对应订单明细表：ods_order_detail_full
public class ods_order_detail_full {
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        String cdcSql = "CREATE TABLE order_detail_full_mq (\n" +
        ...
        String paimonDDl = "CREATE TABLE IF NOT EXISTS ods.ods_order_detail_full(\n" +
                "    `id` bigint NOT NULL COMMENT '编号',\n" + // 修正原注释（原为"购物券编号"）
        ...
        // 导入任务（完整保留分区逻辑和过滤条件）
        String insertSql = "INSERT INTO ods.ods_order_detail_full(\n" +
                "    `id`, `k1`, `order_id`, `sku_id`, `sku_name`, `img_url`,\n" +
